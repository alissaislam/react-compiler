...
public class ReactParser extends Parser {
	...
	public static final int
		...
		ColonModeCall=167, ReturnModeCall=168, IgSemiColonModeCall=169, SemiColonModeCall=170, 
		WS_INSIDECall=171, NewInCall=172;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"QuestionMarkModeCall", "ColonModeCall", "ReturnModeCall", "IgSemiColonModeCall", 
	...
	public final IfShortContext ifShort() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 255L) != 0) || _la==MoreThanModeCall) {
				{
				setState(315);
				operation();
				setState(316);
	...
	public final JsxBlockContext jsxBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==SemiColon || _la==SemiColonModeCall) {
				{
				{
				setState(552);
				_la = _input.LA(1);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==IgSemiColon || _la==IgSemiColonModeCall) {
				{
				{
				setState(558);
				_la = _input.LA(1);
